  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {filtered.map((r) => (
          <div key={r.id} className="card fade-in" style={{ display: "flex", gap: 20 }}>
            <div style={{ flex: 1 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, flexShrink: 0 }}>
              ...
              <button onClick={() => handleDelete(r.id)} className="btn btn-danger" style={{ padding: "8px 12px" }}><Trash2 size={14} /></button>
            </div>
          </div>
        ))}
      </div>
