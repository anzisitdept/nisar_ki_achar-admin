              ...
              <tr key={o.id}>
                ...
                <td>
                  <div style={{ display: "flex", gap: 6 }}>
                    <a href={`/admin/orders/${o.id}`} className="btn btn-ghost" style={{ padding: "6px 10px" }}><Eye size={14} /></a>
                    <button onClick={() => handleDelete(o.id)} className="btn btn-danger" style={{ padding: "6px 10px" }}><Trash2 size={14} /></button>
                  </div>
                </td>
              </tr>
            ))}
